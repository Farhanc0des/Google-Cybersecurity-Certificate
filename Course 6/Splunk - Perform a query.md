...
6. Let's take a look at three common components: `host`, `source`, `sourcetype`.
...
9. Investigation:
* There are total 109,864 events that are contained in the main index across `all time`.
